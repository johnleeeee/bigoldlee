package com.lzq.commlibs.refreshswipemenulistviewlibrary;
...
import com.lzq.commlibs.refreshswipemenulistviewlibrary.pulltorefresh.interfaces.OnXScrollListener;
import com.lzq.commlibs.refreshswipemenulistviewlibrary.pulltorefresh.view.PullToRefreshListFooter;
import com.lzq.commlibs.refreshswipemenulistviewlibrary.pulltorefresh.view.PullToRefreshListHeader;
import com.lzq.commlibs.refreshswipemenulistviewlibrary.swipemenu.adapter.SwipeMenuAdapter;
...
import com.lzq.commlibs.refreshswipemenulistviewlibrary.swipemenu.interfaces.OnSwipeListener;
import com.lzq.commlibs.refreshswipemenulistviewlibrary.swipemenu.interfaces.SwipeMenuCreator;
import com.lzq.commlibs.refreshswipemenulistviewlibrary.swipemenu.view.SwipeMenuLayout;
...
public class PullToRefreshSwipeMenuListView extends ListView implements AbsListView.OnScrollListener {
	 ...
	 */
	public void stopLoadMore(boolean isLast) {
		if (mPullLoading == true) {
			mPullLoading = false;
			}
		if(isLast == true){
			mFooterView.setState(PullToRefreshListFooter.STATE_LAST);
		}else {
			mFooterView.setState(PullToRefreshListFooter.STATE_NORMAL);
		}
	}
